    ...
    return (
        <div>
            <Card className="p-4 mt-20 h-fit lg:mt-50">
                <p className="text-center font-bold">Kalan Süre</p>
                <div className="flex flex-col">
                    <span className={`self-end font-bold text-2xl ${timer <= 500 ? 'text-red-500' : 'text-black'}`}>{Math.floor(timer / 60)}:{String(timer % 60).padStart(2, '0')}
                    </span>
